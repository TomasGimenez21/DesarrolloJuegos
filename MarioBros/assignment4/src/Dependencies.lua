...
gTextures = {
    ...
    ['Banderita'] = love.graphics.newImage('graphics/Banderita.png'),
    ['poste'] = love.graphics.newImage('graphics/poste.png') 
}
...
gFrames = {
    ...
    ['Banderita'] = GenerateQuads(gTextures['Banderita'], 16, 10),
    ['poste'] = GenerateQuads(gTextures['poste'], 8, 48)
}
