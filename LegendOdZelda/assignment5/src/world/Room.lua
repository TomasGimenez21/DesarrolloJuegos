...
function Room:update(dt)
    ...
    for i = #self.entities, 1, -1 do
        ...
        if entity.health <= 0 then
            ...
            if entity.heart == true then
                table.insert(self.objects, GameObject(GAME_OBJECT_DEFS['heart'],
                entity.x, entity.y))
    ...
    for k, object in pairs(self.objects) do
        ...
        if self.player:collides(object) then
            ...
            if object.type == 'heart' and object.consumed == false and self.player.health<6 then
            ...
            love.window.setTitle(tostring(object.consumed))
